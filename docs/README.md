...
| 2 | `install/upgrade/` | Loki 업그레이드 |
| 3 | `label-guide.md` | 레이블 설계와 카디널리티 관리 |
| 4 | `logql-basics-guide.md`, `logql-advanced-guide.md` | LogQL 조회와 집계 |
| 5 | `promtail-guide.md` | 수집 파이프라인과 pipeline stages |
| 6 | `grafana-integration-guide.md` | Grafana 연결과 탐색 |
| 7 | `alerting-guide.md`, `retention-guide.md` | 알림과 보존 정책 |
| 8 | `log-query-test.md` | 쿼리 실습과 검증 |
...
| 구분 | 문서 |
|------|------|
| 설치/기초 | `install/install.md`, `install/upgrade/`, `label-guide.md` |
...
2. `install/upgrade/`
3. `label-guide.md`
4. `logql-basics-guide.md`
5. `logql-advanced-guide.md`
6. `promtail-guide.md`
7. `grafana-integration-guide.md`
8. `alerting-guide.md`
9. `retention-guide.md`
10. `rules/README.md`
11. `agents/README.md`
